...
def handle_item(item):
    ...
    return
    headline = item.get("headline") or item.get("title") replace("", "")
    summary = item.get("summary") or item.get("content") or ""
    symbol = item.item.get("symbol") or item.get("symbols") or ""
...
def on_close(ws, close_code, close_msg):
    print("WS closed:", close_code, close__msg)
